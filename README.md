...
The user should input the file paths of all the fields included in this study, as indicated in the "Data entry and processing" section.
After running the script, the parameters under investigation will be displayed on the "Correlation Strategy" terminal. 
There, the user is required to input the conditions at hand. 
Additional information about these scripts can be found in the thesis.

**6. Machine Learning Model**

The user should input the file paths of all the fields included in this study, as outlined in the "Array and Correlations" section.
The user then enters the Gauge depth, tubing head pressure, water cut, GOR, and liquid rate in the "new_data" array, and the model will automatically generate the downhole pressure prediction. 
Additional information about these scripts can be found in the thesis.
